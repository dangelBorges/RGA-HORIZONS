...
const ProductionTrajectory = ({ records, clientMapping }) => {
  ...
  return (
    <Card className="border-border bg-slate-950 shadow-lg">
      <div className="flex flex-col lg:flex-row h-full">
        
        {/* Left Control Panel */}
        <div className="w-full lg:w-1/4 p-6 border-b lg:border-b-0 lg:border-r border-border bg-slate-900/50 flex flex-col gap-6">
          <div>
          ...
          <div className="space-y-4">
            <div className="space-y-2">
              ...
              <select 
                className="w-full bg-slate-800 border border-slate-700 text-slate-200 text-sm rounded-md p-2.5 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all"
                value={selectedYear}
                onChange={(e) => {
            ...
            <div className="space-y-2">
              ...
              <select 
                className="w-full bg-slate-800 border border-slate-700 text-slate-200 text-sm rounded-md p-2.5 focus:ring-2 focus:ring-primary focus:border-transparent outline-none transition-all disabled:opacity-50 disabled:cursor-not-allowed"
                value={selectedMonth}
          ...
          {/* Interactive Hint */}
          <div className="bg-slate-800/50 p-3 rounded-md border border-slate-700/50 mt-2">
