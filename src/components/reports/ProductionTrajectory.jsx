...
const ProductionTrajectory = ({ records, clientMapping }) => {
  ...
  const { chartData, plantNames } = useMemo(() => {
    ...
    const finalData = Object.values(groupingMap).sort(
          ...
          <div>
            <div className="flex items-center gap-2 mb-2 text-primary">
              ...
              <h3 className="font-bold text-lg text-primary">
                Trayectoria por cliente
              </h3>
            </div>
            <p className="text-sm text-muted-foreground">
              Visualiza la evolución de producción histórica. Filtra para
              detallar la vista.
            </p>
          </div>
