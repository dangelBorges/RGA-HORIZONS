...
import FiltersAside from "@/components/reports/FiltersAside";
import ChartsGroup from "@/components/reports/ChartsGroup";
import ClientRank from "@/components/reports/ClientRank";
      ...
      <div id="main-content" role="main" className="space-y-6 pb-10">
        ...
        <section className="space-y-6">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-12 gap-6">
            ...
            <ChartsGroup productionByPlant={productionByPlant} />

            <ClientRank productionByClient={productionByClient} maxVolume={productionByClient[0]?.volume_kilos || 1} />
          </div>
        </section>
